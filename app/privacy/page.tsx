...
export const metadata = {
  title: "Privacy Policy | Erez Tire & Auto",
  description: "Privacy Policy for Erez Tire & Auto in Arvada, CO.",
};
  ...
  return (
    <div className="pt-32 pb-24 max-w-4xl mx-auto px-4 md:px-16 text-[#bbc9cd]">
      ...
      <div className="space-y-6 text-lg font-light">
        ...
        <p>At Erez Tire & Auto, we collect information that you provide directly to us when you request an appointment, contact us via phone or text, or visit our shop. This may include your name, phone number, email address, vehicle information, and service history.</p>
