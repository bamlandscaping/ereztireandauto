...
export const metadata = {
  title: "Terms of Service | Erez Tire & Auto",
  description: "Terms of Service for Erez Tire & Auto in Arvada, CO.",
};
  ...
  return (
    <div className="pt-32 pb-24 max-w-4xl mx-auto px-4 md:px-16 text-[#bbc9cd]">
      ...
      <div className="space-y-6 text-lg font-light">
        ...
        <p>By accessing our website or utilizing the services of Erez Tire & Auto, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.</p>
        ...
        <p>Erez Tire & Auto is not responsible for loss or damage to vehicles or articles left in vehicles in case of fire, theft, or any other cause beyond our control.</p>
      </div>
    </div>
  );
}
